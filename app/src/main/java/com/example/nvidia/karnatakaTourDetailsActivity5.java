...
public class karnatakaTourDetailsActivity5 extends AppCompatActivity {

    private static final String TAG = "karnatakaTourDetailsActivity5";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_karnataka_tour_details5);
            ...
            Button bookNowButton = findViewById(R.id.booknowbuton5);
            if (bookNowButton != null) {
                bookNowButton.setOnClickListener(v -> {
                    Log.d(TAG, "Book Now button clicked");
                    try {
                        // Start the karnataka_tour_costActivity
                        Intent intent = new Intent(karnatakaTourDetailsActivity5.this, karnataka_tour_costActivity.class);
                ...
                Log.e(TAG, "Book Now button (booknowbuton5) not found in the layout");
            }
        } catch (Exception e) {
