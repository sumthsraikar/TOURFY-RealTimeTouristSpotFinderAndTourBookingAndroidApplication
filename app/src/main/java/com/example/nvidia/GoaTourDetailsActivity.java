...
public class GoaTourDetailsActivity extends AppCompatActivity {

    private static final String TAG = "GoaTourDetailsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_goa_tour_details);
            ...
            if (bookNowButton != null) {
                bookNowButton.setOnClickListener(v -> {
                    ...
                    try {
                        ...
                        Intent intent = new Intent(GoaTourDetailsActivity.this, karnataka_tour_costActivity.class);
