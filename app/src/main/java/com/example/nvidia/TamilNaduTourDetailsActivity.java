...
public class TamilNaduTourDetailsActivity extends AppCompatActivity {

    private static final String TAG = "TamilNaduTourDetailsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_tamil_nadu_tour_details);
            ...
            if (bookNowButton != null) {
                bookNowButton.setOnClickListener(v -> {
                    ...
                    try {
                        ...
                        Intent intent = new Intent(TamilNaduTourDetailsActivity.this, karnataka_tour_costActivity.class);
