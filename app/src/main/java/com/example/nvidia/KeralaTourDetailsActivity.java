...
public class KeralaTourDetailsActivity extends AppCompatActivity {

    private static final String TAG = "KeralaTourDetailsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_kerala_tour_details);
            ...
            if (bookNowButton != null) {
                bookNowButton.setOnClickListener(v -> {
                    ...
                    try {
                        ...
                        Intent intent = new Intent(KeralaTourDetailsActivity.this, karnataka_tour_costActivity.class);
