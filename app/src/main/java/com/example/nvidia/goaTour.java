...
public class goaTour extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_goa_tour);
        ...
        tourDetailsButton1.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(goaTour.this, GoaTourDetailsActivity.class);
