...
public class maharashtraTour extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_maharashtra_tour);
        ...
        tourDetailsButton1.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(maharashtraTour.this, MTourDetailsActivity.class);
