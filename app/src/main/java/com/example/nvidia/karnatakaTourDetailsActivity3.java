...
// Import statements remain the same as above
...
public class karnatakaTourDetailsActivity3 extends AppCompatActivity {

    private static final String TAG = "karnatakaTourDetailsActivity3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_karnataka_tour_details3);
            ...
            Button bookNowButton = findViewById(R.id.booknowbuton3);
            if (bookNowButton != null) {
                bookNowButton.setOnClickListener(v -> {
                    Log.d(TAG, "Book Now button clicked");
                    try {
                        // Start the karnataka_tour_costActivity
                        Intent intent = new Intent(karnatakaTourDetailsActivity3.this, karnataka_tour_costActivity.class);
                ...
                Log.e(TAG, "Book Now button (booknowbuton3) not found in the layout");
            }
        } catch (Exception e) {
