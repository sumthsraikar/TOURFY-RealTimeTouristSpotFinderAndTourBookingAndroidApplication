...
public class karnatakaTourDetailsActivity extends AppCompatActivity {

    private static final String TAG = "karnatakaTourDetailsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_karnataka_tour_details);
            ...
            if (bookNowButton != null) {
                bookNowButton.setOnClickListener(v -> {
                    ...
                    try {
                        ...
                        Intent intent = new Intent(karnatakaTourDetailsActivity.this, karnataka_tour_costActivity.class);
