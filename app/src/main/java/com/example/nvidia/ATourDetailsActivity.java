...
public class ATourDetailsActivity extends AppCompatActivity {

    private static final String TAG = "ATourDetailsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_atour_details);
            ...
            if (bookNowButton != null) {
                bookNowButton.setOnClickListener(v -> {
                    ...
                    try {
                        ...
                        Intent intent = new Intent(ATourDetailsActivity.this, karnataka_tour_costActivity.class);
